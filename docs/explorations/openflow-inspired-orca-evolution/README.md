...
> **Preservation note (2026-08-28).** These four documents were captured on the
> branch `exploration/openflow-inspired-orca-evolution` and moved here verbatim
> when that branch was deleted. They are kept as a historical record. For how
> this exploration maps onto current `main` — including which parts were adopted
> as Changes 010–016 and which were rejected — read
> `docs/OPENFLOW-EVOLUTION-DELTA.md`, which supersedes this directory.

Status: **NON-BINDING / EXPLORATORY**  
Date captured: **2026-08-20**  
Originally on branch: `exploration/openflow-inspired-orca-evolution` (deleted)
