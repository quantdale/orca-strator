# Delta for Private Phone Access and Notifications
...
- WHEN user navigates the repository list
...
- GIVEN an active run transitions to `BLOCKED` or `RECOVERY_REQUIRED`
- WHEN the event is received
- THEN a prominent alert banner / notification is generated for the user
