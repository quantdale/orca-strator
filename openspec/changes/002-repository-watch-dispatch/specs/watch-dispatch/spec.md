# Delta for Repository Watcher and Transactional Dispatch
...
- THEN it returns current watcher status (idle, polling, error, lastPolledAt, lastObservedSha, activeDispatchId)
